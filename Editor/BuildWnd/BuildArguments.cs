...
namespace AssetBundle
{
    ...
    public class BuildArguments : IEditorPrefs
    {
        ...
        public BuildTargetEnum CurBuildTarget
        {
            get { return EditorPrefsHelper.GetEnum<BuildTargetEnum>("BuildArguments_BuildTargetEnum", BuildTargetEnum.StandaloneWindows64, true); }
            set { EditorPrefsHelper.SetEnum("BuildArguments_BuildTargetEnum", value, true); }
        }
        /// <summary>
        /// 是否转表
        /// </summary>
        ...
        public void ReleaseEditorPrefs()
        {
            ...
            EditorPrefsHelper.DeleteKey("BuildArguments_BuildTargetEnum", true);
        }
        #endregion
    }
}